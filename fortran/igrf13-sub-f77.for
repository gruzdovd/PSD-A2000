      subroutine igrf13(dat,xgeo,Bigrf,bbm)
      double precision date,alt,colat,elong,xx,yx,zx,f
      real*4 xgeo(3), Bigrf(3), Bsph(3), modB, dat, s2car(3,3)
      pi=3.1415926
      date=dat
      x=xgeo(1)
      y=xgeo(2)
      ...
      isv=0
      itype=2
c      write (*,*) alt,colat,elong
      
      call igrf13syn (isv,date,itype,alt,colat,elong,xx,yx,zx,f)
c      write (*,*) xx,yx,zx,f
      Bsph(1)=-Zx
      Bsph(2)=-Xx
      Bsph(3)=Yx
      call sphtocar(theta,phi,s2car)
      call pere2(Bsph, Bigrf, s2car, 1)
      bbm=f
      return
      end
c 
